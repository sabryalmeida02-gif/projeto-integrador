...
function mostrarImpacto(tipo, elementoBotao) {
    ...
    document.getElementById("metrica-valor").innerText = dados.valor;
    document.getElementById("metrica-rotulo").innerText = dados.rotulo;
    document.getElementById("metrica-descricao").innerText = dados.descricao;
}
    elementoBotao.classList.add('active');
